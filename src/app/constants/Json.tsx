...
export const skillData: Skill[] = [
  ...
  { label: "Node Js", percent: "80%", id: "figma", user_name: "jerin_25_01" },
  { label: "Node Js", percent: "85%", id: "node", user_name: "jerin_25_01" },
  { label: "Node Js", percent: "85%", id: "mern", user_name: "jerin_25_01" },
  { label: "Node Js", percent: "85%", id: "react", user_name: "jerin_25_01" },
  {
    label: "Node Js",
    percent: "85%",
    id: "reactnative",
  ...
  { label: "Node Js", percent: "85%", id: "mongodb", user_name: "jerin_25_01" },
  { label: "Node Js", percent: "85%", id: "express", user_name: "jerin_25_01" },
  { label: "Next Js", percent: "90%", id: "nextjs", user_name: "iwin_21_02" },
  { label: "Node Js", percent: "85%", id: "node", user_name: "iwin_21_02" },
  { label: "Node Js", percent: "85%", id: "mern", user_name: "iwin_21_02" },
  { label: "Node Js", percent: "85%", id: "react", user_name: "iwin_21_02" },
  {
    label: "Node Js",
    percent: "85%",
    id: "reactnative",
  ...
  { label: "Node Js", percent: "85%", id: "mongodb", user_name: "iwin_21_02" },
  { label: "Node Js", percent: "85%", id: "express", user_name: "iwin_21_02" },
  { label: "Node Js", percent: "85%", id: "python", user_name: "iwin_21_02" },
  { label: "Node Js", percent: "85%", id: "python", user_name: "@jenisha" },
  { label: "Node Js", percent: "85%", id: "python", user_name: "@paulJdurai" },
  { label: "Node Js", percent: "85%", id: "java", user_name: "@jenisha" },
  { label: "Node Js", percent: "85%", id: "java", user_name: "@paulJdurai" },
  { label: "Node Js", percent: "85%", id: "java", user_name: "iwin_21_02" },
];
