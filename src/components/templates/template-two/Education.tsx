  ...
  const education = [
    {
      ...
      institution: "Adithya Institue of Technology, Coimbatore.",
      period: "2018 – 2022",
      achievements: [
        "Graduated with honors with a GPA of 8.75.",
        "Specialized in Web Technologies and Artificial Intelligence",
        "Developed a Financial Asset Prediction Model leveraging Machine Learning algorithms to enhance investment decision-making accuracy.",
      ],
    },
  ];
