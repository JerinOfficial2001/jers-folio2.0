...
const skills = [
  {
    ...
    tech: "React.js, Next.js HTML, CSS",
    description:
  ...
  },
  {
    ...
    tech: "Web3.js, Solidity, Binance Smart Chain, Ethereum, Smart Contracts",
    description:
      "Building secure and automated blockchain solutions for decentralized applications.",
    color: "text-cyan-500",
  },
  {
    icon: GitBranch,
  ...
  },
  {
    ...
    tech: "Redux, Context API, Zustand",
    description:
